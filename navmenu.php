<?php if (isset($_SESSION['id']) || !empty($_SESSION['id'])): ?>
    <?php switch ($_SESSION['auth']) {
        case '1':
            ...
            echo '<a href="index.php?p=7"><img src="elemek/ikonok/targonca_vezeto.png" alt="tarolo" style="width:150px;height:150px;"><span class="megnevezes">Készlet mozgás</span>';
            ...
            echo '<a href="index.php?p=11"><img src="elemek/ikonok/tarolo.png" alt="tarolo" style="width:150px;height:150px;"><span class="megnevezes">Alk. tevékenységek</span>';
            break;
        case '2':
