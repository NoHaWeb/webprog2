<?php require_once 'db_kapcsolat.php' ; require_once 'crud.php' ; $db=new Database(); $crudManager=new
    CRUDManager($db); $kategoriak=$crudManager->performCRUD("select", "kategoriak", "", "");
